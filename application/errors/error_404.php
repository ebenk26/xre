...
<head>
    ...
    <link href="<?php echo ASSETS;?>css/components.min.css" rel="stylesheet" id="style_components" type="text/css" />
    <link href="<?php echo ASSETS;?>css/plugins.min.css" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="<?php echo ASSETS;?>css/error.min.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo ASSETS;?>plugins/ie8.fix.min.js"></script> 
<![endif]-->
    <!-- BEGIN CORE PLUGINS -->
    <script src="<?php echo ASSETS;?>plugins/jquery.min.js" type="text/javascript"></script>
    <script src="<?php echo ASSETS;?>plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?php echo ASSETS;?>plugins/js.cookie.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo ASSETS;?>plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
    <!-- END CORE PLUGINS -->
    <!-- BEGIN THEME GLOBAL SCRIPTS -->
    <script src="<?php echo ASSETS;?>scripts/app.min.js" type="text/javascript"></script>
