...
class User_Model extends CI_Model{
    ...
    public function loginUser($email, $password){
        $this->db->select('users.id as id,users.country as country, users.password as password, users.email as email, users.fullname as name, users.verified as verified, users.status as status, users.remember_token as remember_token, users.last_seen_notif, roles.slug as roles, profile_uploads.name as img_profile, profile_uploads.type as img_type');
        $this->db->from('users');
