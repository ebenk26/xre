        ...
        <div class="portlet mb-0 ">
            <div class="portlet light md-transparent  p-0">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-weight-300 text-capitalize opensans-font font-44">Company Profile</span>
                    </div>
                    <div class="actions">
                        <a href="<?php echo base_url(); ?>profile/company/<?php echo rtrim(base64_encode($this->session->userdata('id')),'=') ?>" target="_blank" class="btn btn-md-indigo btn-lg ">View My Profile</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mt-element-card-v2 ">
                            <div class="mt-card-item p-0">
                                ...
                                <div class="mt-card-avatar text-center p-0">
                                    <img src="<?php echo !empty($profile_picture) ?  IMG_EMPLOYERS.$profile_picture['name'] : IMG.'/site/xremo-logo-blue.svg'?>" class=" avatar avatar-large avatar-circle mt-o-150 ">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title tabbable-line tab-md-indigo  flex-center ">
                                <ul class="nav nav-tabs ">
                                    <li class="active ">
                                        <a href="#tab_about_info" data-toggle="tab" class="font-22">
                                            <i class="fa fa-building-o"></i>About Company</a>
                                    </li>
                                    <li>
                                        <a href="#tab_contact_info" data-toggle="tab" class="font-22">
                                            <i class="icon-pointer"></i>Company Location </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="portlet-body tab-content">
                                ...
                                <div class="tab-pane active" id="tab_about_info">
                                    ...
                                    <div class="m-grid m-grid-col m-grid-responsive-xs ">
                                        <div class="portlet portlet-body">
                                            ...
                                            <?php }else{ ?>
                                            <div class="portlet p-50 md-shadow-none bg-grey-cararra">
                                    ...
                                    <div class="m-grid  m-grid-responsive-xs">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <h5 class="roboto-font font-weight-300">
                                                        <?php echo !empty($detail['spoken_language']) ?  $detail['spoken_language'] : '<h6 class="font-grey-cascade mt-5 text-none">Edit your info by clicking on " <i class="icon-pencil"></i> Edit Profile" button</h6>'; ?>
                                                    </h5>
                                                </li>
                                                <!-- Dress Code  -->
                                                <li>
                                                    ...
                                                    <h5 class="roboto-font font-weight-300">
                                                        <?php echo !empty($dresscode) ? ucwords($dresscode) : '<h6 class="font-grey-cascade mt-1 text-none">Edit your info by clicking on " <i class="icon-pencil"></i> Edit Profile" button</h6>' ?> </h5>
                                                ...
                                                <li>
                                                    ...
                                                    <h5 class="roboto-font font-weight-300">
                                                        <?php echo !empty($detail['benefits']) ? $detail['benefits'] : '<h6 class="font-grey-cascade mt-1 text-none">Edit your info by clicking on " <i class="icon-pencil"></i> Edit Profile" button</h6>'?>
                                                    </h5>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="m-grid-col m-grid-col-sm-6 m-grid-col-xs-12">
                                            <ul class="list-unstyled">
                                                <li>
                                                    <h5 class="mb-10 font-weight-600 md-indigo-text"> Working Hour</h5>
                                                    <h5 class="roboto-font font-weight-300">
                                                        ...
                                                        <?php }else{?>
                                                        <h6 class="font-grey-cascade mt-1 text-none">Hour not set. Click "
                                                            <i class="icon-pencil"></i> Edit Profile" button</h6>
                                                        <?php }?>
                                                        <?php }else{?>
                                                        <h6 class="font-grey-cascade mt-1 text-none">Edit your info by clicking on "
                                                            <i class="icon-pencil"></i> Edit Profile" button</h6>
                                                        <?php }?>
                                                    </h5>
                                                </li>
                                ...
                                <div class="tab-pane " id="tab_contact_info">
                                    ...
                                    <ul class="list-unstyled mt-25">
                                        ...
                                        <li>
                                            <span class="label label-<?php echo ($value->optionsRadios=='HQ') ? 'md-orange' : 'md-indigo' ?>">
                                    ...
                                    <div class="portlet p-50 md-shadow-none bg-grey-cararra">
                                        <div class="portlet-body text-center">
                                            <i class="icon-note font-grey-mint font-40 mb-20"></i>
                                            <h4 class="text-center font-weight-500 font-grey-mint">No Info</h4>
                                            <h5 class="text-center  font-grey-cascade mt-5 text-none">Edit your info by clicking on "
                                                <i class="icon-pencil"></i> Edit Profile"</h5>
                                        </div>
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group mx-0">
                                            ...
                                            <textarea class="autosizeme form-control" rows="4" placeholder="Annual Leaves , Allowances , Medicalfee , Dental Fee ,Annual Trip" name="benefits">
                                                <?php echo !empty($user_profile['benefits']) ? $user_profile['benefits'] : ''; ?>
                                            </textarea>
                                            ...
                                            <div class="m-grid">
                                                ...
                                                <div class="m-grid-col m-grid-col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control timepicker timepicker-no-seconds" placeholder="Start At" name="work_hour_start" value="<?php echo $detail['working_hours_start'] != "
                                                            " ? $detail['working_hours_start'] : '' ?>">
                                                ...
                                                <div class="m-grid-col m-grid-col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control timepicker timepicker-no-seconds" placeholder="End At" name="work_hour_end" value="<?php echo $detail['working_hours_end'] != "
                                                            " ? $detail['working_hours_end'] : '' ?>">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-clock-o"></i>
                                                            </button>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="form-group mx-0 ">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                        <span class="btn btn-md-red btn-outline btn-file">
