...
<!-- BEGIN FOOTER -->
    ...
    <script src="<?php echo JS_EMPLOYER; ?>bootstrap-tagsinput.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo JS_EMPLOYER; ?>components-bootstrap-tagsinput.min.js" type="text/javascript"></script>
