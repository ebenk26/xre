...
<script>
    $(document).ready(function () {
        ...
        tinymce.init({
            ...
            height: 400,
            theme: 'modern',
            plugins: 'code advlist autolink lists link image charmap hr anchor pagebreak searchreplace wordcount visualblocks visualchars fullscreen insertdatetime nonbreaking save table contextmenu directionality template paste textcolor colorpicker textpattern imagetools codesample toc',
            ...
            toolbar2: 'fontsizeselect forecolor backcolor emoticons | codesample',
