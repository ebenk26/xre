...
<?php $checkUserProfile = get_headers(IMG_EMPLOYERS.$user_profile['img']); ?>
    <!-- BEGIN HEADER -->
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="<?php echo ucfirst($user_profile['name']); ?> " class="avatar avatar-xtramini avatar-circle" src="<?php echo $checkUserProfile ?  IMG_EMPLOYERS.$user_profile['img'] : IMG.'site/profile-pic.png'?>">
