    ...
    <div class="page-content">
        <div class="portlet light md-transparent portlet-fit p-0">
            <div class="portlet-title tabbable-line tab-md-indigo py-0  pl-0 mb-0 border-md-grey">
                <div class="caption">
                    <span class="caption-subject font-weight-300 text-capitalize primary-font font-44">
                ...
                <ul class="nav nav-tabs ">
                    <li class="active">
                        <a href="#tab_new_candidates" data-toggle="tab">
                            <i class="icon-users font-26"></i> New </a>
                    </li>
                    <li>
                        <a href="#tab_shortlisted_candidates" data-toggle="tab">
                            <i class="icon-user-following font"></i> Shortlisted </a>
                    </li>
                </ul>
            </div>
        </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#modal_rescheduled_form_<?php echo $value['interview_schedule_id'];?>" class="choose_session" candidate-email="<?php echo $value['user_email']; ?>" candidate-name="<?php echo $value['user_name'];?>"
                                                        data-toggle="modal" candidate-id="<?php echo rtrim(base64_encode($value['user_id']),'='); ?>" job-id="<?php echo rtrim(base64_encode($job->id),'=')?>">
                                                        <i class="icon-calendar"></i>
                                                        Rescheduled Interview
                                                    </a>
                                                    <?php else: ?>
                                                    <a href="#modal_set_session_<?php echo rtrim(base64_encode($value['user_id']),'='); ?>" candidate-email="<?php echo $value['user_email']; ?>" candidate-name="<?php echo $value['user_name'];?>" data-toggle="modal"
                                                        candidate-id="<?php echo rtrim(base64_encode($value['user_id']),'='); ?>" job-id="<?php echo rtrim(base64_encode($job->id))?>">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content form">
                                    ...
                                    <form action="<?php echo base_url(); ?>employer/candidate/reschedule_interview_session" method="POST" class="form-horizontal">
                                        ...
                                        <div class="modal-body form-body">
                                            <div class="row mx-0">
                                                <div class="form-group mx-0 col-md-12">
                                                    <label class="control-label font-weight-600">Requested By</label>
                                                    <br>
                                                    <label class="control-label">
                                                        <?php echo $value['user_name'];?>
                                                    </label>
                                                    <br>
                                                    <label class="control-label font-weight-600">Proposed Start Date</label>
                                                    <br>
                                                    <label class="control-label">
                                                        <?php echo date('d M Y H:i:s', strtotime($value['suggested_start_date'] ));?>
                                                    </label>
                                                    <br/>
                                                    <label class="control-label font-weight-600">Proposed End Date</label>
                                                    <br>
                                                    <label class="control-label">
                                                        <?php echo date('d M Y H:i:s', strtotime($value['suggested_end_date'] ));?>
                                                    </label>
                                                    <br>
                                                    <label class="control-label font-weight-600">Reschedule Reason</label>
                                                    <br>
                                        ...
                                        <div class="modal-footer ">
                                            <button class="btn btn-md-indigo "> Send </button>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php echo !empty($session_value['start_date']) ? date('d F Y - H:i', strtotime($session_value['start_date'])) : '01 January 2018 - 00:00'; ?>
                                    </div>
                                </li>
                                <!-- To -->
                                <li>
                                    ...
                                    <div class="col-md-9">
                                        <i class="icon-calendar mr-2"></i>
                                        <?php echo !empty($session_value['end_date']) ? date('d F Y - H:i', strtotime($session_value['end_date'])) : '01 January 2018 - 00:00'; ?>
                                    </div>
                                </li>
                                <!-- Details -->
                                <li>
