            ...
            <div class="page-content">
                <div class="portlet light md-transparent portlet-fit p-0">
                    <div class="portlet-title tabbable-line tab-md-indigo py-0  pl-0 mb-0 border-md-grey">
                        <div class="caption">
                            <span class="caption-subject font-weight-300 text-capitalize primary-font font-44-xs"> <?php echo !empty($job) ? $job->name : 'none'; ?></span>
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span><?php echo !empty($job) ? $job->name : 'none'; ?> [Candidate List]</span>
                            <!-- <i class="fa fa-angle-right"></i> -->
                        </li>
                    </ul>
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject"><?php echo !empty($job) ? $job->name : 'none'; ?></span>
                                    <span class="caption-helper ">New Candidates</span>
                                </div>
                                <!-- <div class="actions">
                        ...
                        <div class="portlet portlet-fit light ">
                            ...
                            <?php else: ?>
                                <div class="portlet-body text-center">
                                    ...
                                    <!-- <a href="employer-purchasepackage.html" class="btn btn-outline-md-indigo px-6">New Candidate</a> -->
                                </div>    
                            <?php endif ?>
                        </div>
