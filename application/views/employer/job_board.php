            ...
            <form action="<?php echo base_url(); ?>employer/job_board/post" id="post_job" method="POST" class="form-horizontal ">
                <div class="modal-body form-body ">
                    ...
                    <div class="row ">
                        <div class="col-md-4">
                            <div class="form-group mx-0">
                                <label class="control-label md-grey-darken-3-text mb-10 font-weight-600 ">Employment Type</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mx-0">
                                <label class="control-label md-grey-darken-3-text mb-10 font-weight-600 ">Position Level</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mx-0">
                                <label class="control-label md-grey-darken-3-text mb-10 font-weight-600">Years Of Experience</label>
        ...
        <div class="modal-content ">
            ...
            <form action="<?php echo base_url(); ?>employer/job_board/update/" method="POST" class="form-horizontal  ">
                ...
                <div class="modal-body form-body ">
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="mb-50 " style="height: 400px; " id="map-window<?= $value['id'];?>">
