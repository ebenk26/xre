                                ...
                                <div class="inbox-sidebar">
                                    ...
                                    <ul class="inbox-nav">
                                        <li class="<?=$type == "inbox"?"active":""?>">
											<a href="<?=base_url()?>employer/inbox" data-type="inbox" data-title="Inbox"> Inbox
                                                <?=$new > 0?'<span class="badge badge-success">'.$new.'</span>':''?>
                                            </a>
                                        </li>
                                        <li class="<?=$type == "sent"?"active":""?>">
                                            <a href="<?=base_url()?>employer/sent" data-type="sent" data-title="Sent"> Sent </a>
                                        </li>
                                        <!--<li class="">
                                        ...
                                        <li class="<?=$type == "trash"?"active":""?>">
                                            <a href="<?=base_url()?>employer/trash" class="sbold uppercase" data-title="Trash"> Trash
