        ...
        <div class="portlet mt-0 ">
            <div class="tab-content">
                ...
                <div class="tab-pane <?=$tab_student =='tab_overview' || $tab_student == '' ?'active':' '?>" id="tab_overview">
                    <!-- # Header Image -->
                    <div class="view height-300 bg-position-center" style="background:url(' <?= file_exists(IMG_STUDENTS.$user_profile['header_photo']) ?  IMG_STUDENTS.$user_profile['header_photo'] : IMG_STUDENTS.'33.jpg'; ?>') center center no-repeat">
                                ...
                                <div class="mt-element-card-v2 ">
                                    <div class="mt-card-item p-0">
                                        ...
                                        <div class="mt-card-avatar text-center p-0">
                                            <img src="<?= file_exists(IMG_STUDENTS.$user_profile['profile_photo']) ?  IMG_STUDENTS.$user_profile['profile_photo'] : IMG.'site/profile-pic.png'; ?>" class="avatar avatar-circle avatar-large mt-o-170">        
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group mx-0">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                        <img src="<?php echo file_exists(IMG_STUDENTS.$user_profile['profile_photo']) ?  IMG_STUDENTS.$user_profile['profile_photo'] : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image'; ?>" alt="Profile Picture"> </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mx-0">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                        <img src="<?php echo file_exists(IMG_STUDENTS.$user_profile['header_photo']) ?  IMG_STUDENTS.$user_profile['header_photo'] : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image'; ?>" alt="Profile Picture"> </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                                    <div>
                                                        <span class="btn btn-md-grey btn-file">
                                                            <span class="fileinput-new"><?= !empty($language->site_select_image) ? $language->site_select_image : "Select Image" ?></span>
