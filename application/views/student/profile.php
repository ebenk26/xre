                                ...
                                <div class="mt-element-card-v2 ">
                                    <div class="mt-card-item p-0">
                                        <div class="mt-card-avatar text-center p-0">
                                            <img src="<?php echo IMG_STUDENTS; ?>team5.jpg" class="avatar-circle avatar-large avatar-border border-md-indigo lighten-5 mt-margin-t-o-150-xs">
                                        ...
                                        <div class="mt-card-content  ">
                                            ...
                                            <p class="mt-card-desc md-grey-text text-lighten-1">
                                                    ...
                                                    <li class="font-26-xs"><i class="icon-briefcase mr-2"></i><?php echo $this->session->userdata('roles');?></li>
                                                    ...
                                                    <li class="font-26-xs"><i class="icon-pointer"></i> Perak , Malaysia</li>
                                        ...
                                        <div class="m-grid">
                                            <div class="m-grid-col">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <h5 class="roboto-font"><?php echo $user_profile['overview']['student_bios_address'];?></h5>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="m-grid">
                                            ...
                                            <div class="m-grid-col">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <h5 class="roboto-font">Batu Caves</h5>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="m-grid">
                                            <div class="m-grid-col">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <h5 class="roboto-font"><?php echo $user_profile['overview']['states'];?></h5>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="m-grid-col">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <h5 class="roboto-font"><?php echo $user_profile['overview']['country'];?></h5>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="tab-pane " id="tab_education">
                    <div class="portlet light md-shadow-none">
                        <div class="portlet-title ">
                            ...
                            <!-- Modal Add education -->
                            <div class="actions">
                                <a href="https://xremo.github.io/XremoFrontEnd/custom_pages/student-profile-v3.html#modal_add_education" data-toggle="modal" class="btn btn-md-indigo btn-circle"><i class="fa fa-plus  "></i> Add </a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <div class="media p-0">
                                <div class="pull-right my-4 ">
                                    ...
                                    <a href="https://xremo.github.io/XremoFrontEnd/custom_pages/student-profile-v3.html" class="btn btn-md-red btn-icon-only"><i class="icon-trash"></i></a>
                                </div>
                    ...
                    <div class="modal-content portlet light ">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active " id="tab_profile">
                                <form id="profile" method="POST" class="form">
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 343.75px;"><div class="scroller mt-height-550-xs" data-always-visible="1" data-rail-visible1="1" data-initialized="1" style="overflow: hidden; width: auto; height: 343.75px;">
                                        <div class="modal-body portlet-body form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control input-medium" placeholder="Jenny" name="student_name">
                                                </div>
                                            </div>
                                            <!-- Full name -->
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control input-xlarge" name="fullname" placeholder="Jennifer Lawrence">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="DOB" class="form-control date-picker" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="current" placeholder="Student">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control " name="address" placeholder="Unit / Lot , Road , Postcode , City , State , Country">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="" class="form-control" id="" rows="3" placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi consectetur possimus pariatur nihil praesentium veniam asperiores, debitis consequatur commodi esse, id sit? Perferendis maxime ea odit asperiores animi earum pariatur!"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="" class="form-control" id="" rows="3" placeholder="Summarize about yourself"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control input-xlarge" placeholder="link video">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-body portlet-body ">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 343.75px;"><div class="scroller mt-height-550-xs" data-always-visible="1" data-rail-visible1="1" data-initialized="1" style="overflow: hidden; width: auto; height: 343.75px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control " placeholder="University of Malaya">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control " placeholder="Bachelor&#39;s Degree">
                                            <!-- <span class="help-block"> A block of help text.</span> -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9  ">
                                            <div class="m-grid ">
                                                <div class="m-grid-col m-grid-col-xs-6">
                                                    <input class="form-control form-control-inline date-picker " size="16" type="text" value="" placeholder="From year">
                                                ...
                                                <div class="m-grid-col m-grid-col-xs-6">
                                                    <input class="form-control form-control-inline date-picker" size="16" type="text" value="" placeholder="End Year">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="4" placeholder="Brief about your studying place and what subject you had study."></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-body portlet-body ">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 281.25px;"><div class="scroller mt-height-450-xs" data-always-visible="1" data-rail-visible1="1" data-initialized="1" style="overflow: hidden; width: auto; height: 281.25px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control " placeholder="Internship in IT Dept">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Description</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control autosizeme" rows="4" placeholder="Brief about your working place ...." data-autosize-on="true" style="overflow-y: visible; overflow-x: hidden; word-wrap: break-word; resize: horizontal;"></textarea>
                                        </div>
                                    </div>
                                    <!-- TIme Period  -->
                                    <div class="form-group">
