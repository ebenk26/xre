<?php if(empty($roles) || $this->session->userdata('id') != $user_profile['overview']['id_users']){ ?>
    <div class="portlet p-20 md-shadow-none bg-grey-cararra">
        <div class="portlet-body text-center">
            <i class="icon-puzzle font-grey-mint font-40 mb-20"></i>
...
<?php if(!empty($roles) && $this->session->userdata('id') == $user_profile['overview']['id_users']){ ?>
    <div class="portlet p-20 md-shadow-none bg-grey-cararra">
        <div class="portlet-body text-center">
            <i class="icon-ghost font-grey-mint font-40 mb-20"></i>
