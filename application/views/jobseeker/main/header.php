            ...
            <div class="page-top">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        $checkGetProfileImage = file_exists(IMG_STUDENTS.$user_profile['profile_photo']);
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                $checkGetProfileImage == true ? IMG_STUDENTS.$user_profile['profile_photo'] : IMG_STUDENTS.'profile-pic.png';?>" />
