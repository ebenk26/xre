    ...
    <!-- BEGIN FOOTER -->	
	<div class="page-footer pull-right mdo-white-light-text">
        <div class="page-footer-inner"> <?=date('Y')?> ©
			<a target="_blank" class="mdo-white-light-text" href="https://www.xremo.com">Xremo Sdn. Bhd.</a> &nbsp;|&nbsp;
			<a target="_blank" class="mdo-white-light-text" href="<?=base_url()?>terms-of-use">Terms of Use</a> &nbsp;|&nbsp;
			<a target="_blank" class="mdo-white-light-text" href="<?=base_url()?>privacy">Privacy Policy</a><!-- &nbsp;|&nbsp;
			<a target="_blank" class="mdo-white-light-text" href="faq.html">FAQ</a>-->
			<div class="scroll-to-top" style="display: none;">
				<i class="icon-arrow-up"></i>
			</div>
		</div>
		<!--<div class="page-footer-inner"> <?php echo date('Y') ?> © Copyright By Xremo</div>-->
        <div class="scroll-to-top" style="display: none;">
            <i class="icon-arrow-up"></i>
        </div>
    </div>
