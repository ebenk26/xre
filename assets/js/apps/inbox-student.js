var AppInbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = '/custom_pages/student-inbox-list.html';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = '/custom_pages/student-inbox-view.html';
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                // $('.inbox-header' ).append('<a class="btn btn-md-indigo inbox-discard-btn "> <i class="icon-action-undo"></i></a>');
                
                $('.inbox-header').on('click', '.inbox-discard-btn', function (e) {
                ...
                // $('.inbox-header').append('<a class="btn btn-md-indigo inbox-discard-btn"> <i class="icon-action-undo"></i></a>');
                // $('.inbox-header').removeClass('<a class="btn btn-md-indigo inbox-discard-btn"> <i class="icon-action-undo"></i></a>');
    ...
    return {
        ...
        init: function () {
            ...
            $('.inbox').on('click', '.view-message', function () {
                // e.preventDefault();
                // $('.inbox-header').append('<a class="btn btn-md-indigo inbox-discard-btn pull-right"> <i class="icon-action-undo "></i></a>');
                loadMessage($(this));
            });
